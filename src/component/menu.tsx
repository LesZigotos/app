...
function BurgerMenu(props: MenuProps) {
    ...
    return (
        <div>
            ...
            />
            <nav data-open={JSON.stringify(open)} className={`flex flex-col gap-12 max-w-full h-screen bg-primary-dark text-white text-3xl font-medium text-left p-8 z-50 fixed top-0 right-0 transition-transform ease-in-out duration-300 ${open ? 'translate-x-0' : 'translate-x-full'} `}>
