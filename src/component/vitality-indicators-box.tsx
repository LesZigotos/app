...
function VitalityIndicatorsBox({ indicators }: VitalityIndicatorsProps) {
  return (
    <div className="flex flex-col gap-3 bg-white p-8 rounded-lg shadow">
      ...
      <VitalityIndicatorsRow
        ...
        icon={
          <svg
            ...
            viewBox="0 0 512 512"
          >
            <path d="M352.213,170.188V39.385h15.369c10.875,0,19.692-8.817,19.692-19.692C387.274,8.817,378.457,0,367.582,0c-5.156,0-208.595,0-223.043,0c-10.875,0-19.692,8.817-19.692,19.692c0,10.875,8.817,19.692,19.692,19.692h15.369c0,13.039,0,116.914,0,130.804C3.377,266.065,69.779,512,256.06,512C440.663,512,509.517,266.538,352.213,170.188z" />
          </svg>
        }
      ...
      <VitalityIndicatorsRow
        ...
        icon={
          ...
          >
            <path d="M466.967,169.168c-40.3-37.8-106.8-24.3-153.4,21.8c-41.8,43.4-55.8,97.9-35.2,135.1c-9.3,5.4-22,12.8-24.9,14.2c-21.8,12.4-44.8,32.4-38.3,73.6c-6.5,12-23.5,40.3-48.7,34.2c-11.4-1-21.8,7.3-22.8,18.7s7.3,21.8,18.7,22.8c24.4,3.6,46.6-4.2,66.3-24.9c9.3-9.3,34.4-29,28-71.5c1-5.2,7.3-11.4,17.6-17.6c2.6-1.7,22.7-10.4,35.3-19.6c38.7,20.5,89.8,7.5,135.7-34.3C491.467,272.068,506.767,214.168,466.967,169.168z" />
          </svg>
        }
