    ...
    return (
        <div className="flex flex-col gap-4 bg-white p-8 rounded-lg">
            ...
            <VitalityIndicatorsRow
                title="Fertilité"
                icon={
                    <svg className="w-5" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
