...
const educationalCards: EducationalCardData[] = [
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1502813514270-9fed4f4900aa?q=80&w=1925&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1719163363742-cd2637b67311?q=80&w=1990&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1621775595317-4de3a6646c6c?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  },
  {
    ...
    imageUrl:
      "https://plus.unsplash.com/premium_photo-1726072356923-bf1a9f8faeb0?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1536625637853-ec02b2b4edbd?q=80&w=1976&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1649347173558-a305d7b8ff98?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ...
    <div className="bg-white w-2/4 max-md:w-full shadow-lg rounded-lg p-6 mb-6">
      <div className="flex justify-between">
        <div className="flex flex-row max-xl:flex-col-reverse justify-between gap-24 w-full max-lg:items-center ">
          ...
          <img className="h-72 w-72 object-cover rounded-3xl" src={imageUrl} alt="Illustration" />{" "}
        </div>
      </div>
      {isExpanded && (
        <div>
          <h2 className="text-xl font-medium">Fonctionnement : </h2>
          ...
          <hr/>
          <div className="mt-4 px-12 text-gray-600">
